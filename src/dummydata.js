...
export const blog = [
  {
    ...
    date: "JUN. 17, 2023",
    // com: "3 COMMENTS ",
    title: "Class of 2023 Grand opening ceremony",
    desc: "Celebrate the extraordinary Class of 2023 at their grand opening ceremony, a remarkable event filled with pride, joy, and inspiration. ",
    cover: "../images/event/day1/1stm.jpeg",
  },
  {
    id: 2,
    location: "Ghana",
    date: "JUN. 17, 2023",
    // com: "5 COMMENTS ",
    title: "Preparing your college applications essays",
    desc: "Discover the key steps to excel in your college application essays and make a lasting impression on admissions committees.",
    cover: "../images//event/day1/writing.jpeg",
  },
  // {
  //   id: 3,
  //   location: "Ghana",
...
export const partners=[
  {
  id:1,
  img:"./images/partners/dhs.png",
  name:"Dream Hive"
},
{
  id:2,
  img:"./images/partners/uni.jpg",
  name:"Uni Ghana"
},
{
  id:3,
  img:"./images/partners/nolb.jpg",
  name:"NOLBED Foundation"
},
]
...
export const services =[
  {
    id:1,
    title:"Recruit scholars",
    details:"We reach out to schools in rural areas, through conducting workshops and using online broadcasting methods, to identify students who are highly talented but come from low-income backgrounds. We distribute application forms to these students and invite them to apply to become scholars in our program. Those who are qualified are then chosen and recruited to receive our services."
  },
  {
    id:2,
    title:"Prepare our scholars",
    details:"As part of our preparation toward school and scholarship applications, we coach our scholars on how to write scholarship and school application essays, introduce them to LinkedIn, and educate them on how to send out professional e-mails.    </p>"
  },
  {
    id:3,
    title:"Support our scholars",
    details:"We assist our scholars with application fee waivers. We strive to assist our scholars in securing scholarships in top-tier universities in Ghana and abroad. While our scholars are in school, we provide them with buddy-up coaching, mentorship and job shadowing assistances. We also assist them in securing internship opportunities.    </p>"
  }
]